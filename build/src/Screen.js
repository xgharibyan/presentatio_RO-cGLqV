System.register(['rodin/core'], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            class Screen extends RODIN.Plane {
                constructor() {
                     ...
                     */
                    this.slides = [RODIN.Loader.loadTexture('images/presentation/p1.jpg'), RODIN.Loader.loadTexture('images/presentation/p2.jpg'), RODIN.Loader.loadTexture('images/presentation/p3.jpg'), RODIN.Loader.loadTexture('images/presentation/p4.jpg'), RODIN.Loader.loadTexture('images/presentation/p5.jpg'), RODIN.Loader.loadTexture('images/presentation/p6.jpg'), RODIN.Loader.loadTexture('images/presentation/p7.jpg'), RODIN.Loader.loadTexture('images/presentation/p8.jpg'), RODIN.Loader.loadTexture('images/presentation/p9.jpg'), RODIN.Loader.loadTexture('images/presentation/p10.jpg'), RODIN.Loader.loadTexture('images/presentation/p11.jpg'), RODIN.Loader.loadTexture('images/presentation/p12.jpg'), RODIN.Loader.loadTexture('images/presentation/p13.jpg'), RODIN.Loader.loadTexture('images/presentation/p14.jpg'), RODIN.Loader.loadTexture('images/presentation/p15.jpg')];
